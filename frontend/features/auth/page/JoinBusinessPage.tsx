      ...
      <div className="relative z-10 flex flex-1 flex-col px-8">
        ...
        <div className="mt-4 flex flex-col items-center">
          ...
          <p className="mt-3 max-w-sm text-center text-base leading-7 text-slate-500">
            Sign in with your Google account to securely join your organisation.
          </p>
        </div>
        ...
        <div className="mt-12 space-y-5 rounded-3xl border border-sky-100 bg-sky-50/40 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Connect using a Business ID or QR code.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Your request is reviewed before access is granted.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                One secure account with role-based access.
              </p>
            </div>
          </div>
        </div>
