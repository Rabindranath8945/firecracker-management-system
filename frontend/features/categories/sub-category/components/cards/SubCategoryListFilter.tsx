...
interface SubCategoryListFilterProps {
  total: number;
...
export default function SubCategoryListFilter({
  total,
  status,
  onStatusChange,
  sort,
  onSortChange,
}: SubCategoryListFilterProps) {
  return (
    <section className="mb-5">
      ...
      <div className="mb-3 flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-slate-900">Sub Categories</h2>

          <p className="mt-1 text-sm text-slate-500">
            Organize products into sub categories
          </p>
        </div>
